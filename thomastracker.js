...
if (st=='js') { // calling logger by JavaScript-tag
	...
	document.open();
	document.write("<script language=\"JavaScript\" type=\"text/javascript\" src=\"http://www.thomastracking.com/pphlogger.php"+r+"\"></script>");
	document.close();
} else { // calling PowerPhlogger by IMG-tag
	rand = Math.round(1000*Math.random());
	r = r+"&b="+rand;  //force the page to load the IMG
	document.open();
	document.write("<img src=\"http://www.thomastracking.com/pphlogger.php"+r+"\" alt=\"\" border=\"0\">");
	document.close();
}
